...
- **中国儿童免疫规划标准疫苗**：22 种默认疫苗（乙肝、卡介苗、脊灰、百白破等）
- **按月龄分组时间线**：出生/1月/2月/3月/4月/5月/6月/8月/9月/18月/4岁/6岁
- **预计接种时间**：根据宝宝出生日期+月龄自动计算显示
- **接种操作**：点击"未接种"按钮弹出日期选择器，确认后变更为"已接种"
- **状态显示**：未接种显示预计时间，已接种显示实际接种日期
- **自定义时间**：可修改预计接种日期
- **首次加载**：自动创建所有默认疫苗记录到飞书表
...
### v1.7 疫苗接种（2026-07）
- 疫苗接种表：Worker 自动创建（疫苗名称/月龄/接种状态/预计接种日期/实际接种日期/剂次/疫苗类型/备注/关联宝宝）
- 22 种中国儿童免疫规划标准疫苗（乙肝、卡介苗、脊灰、百白破、麻腮风、乙脑、A群流脑、甲肝、白破等）
- 按月龄分组时间线展示（出生/1月/2月/3月/4月/5月/6月/8月/9月/18月/4岁/6岁）
- 预计接种时间根据宝宝出生日期+月龄自动计算
- 点击"未接种"按钮弹出日期选择器，确认后变更为"已接种"
- 已接种左侧显示实际接种日期，未接种显示预计时间
- 首页增加 💉 疫苗接种入口卡片
- /vaccine 路由 → VaccinePage
- /api/vaccines 路由：GET/POST/PUT/DELETE 疫苗 CRUD
- ensureVaccineTable 自动建表 + 首次加载创建默认疫苗记录
