...
graph TB
    ...
    subgraph DATALAYER["数据层"]
        ...
        D1["宝宝档案表<br/>tbl3JyDUCGTsyNnj"]
        D2["每日记录表<br/>tblO06JFd4XfZHCD"]
        D3["成长里程碑表<br/>tbldWe9a9l80Qoho"]
    end
...
#### 获取宝宝信息
```
GET /open-apis/bitable/v1/apps/{base_token}/tables/tbl3JyDUCGTsyNnj/records
  ?page_size=1
```

#### 创建每日记录
```
POST /open-apis/bitable/v1/apps/{base_token}/tables/tblO06JFd4XfZHCD/records
Body: {
  "fields": {
    "记录内容": "今天学会说车车",
    "分类": "语言",
...
#### 查询记录列表
```
GET /open-apis/bitable/v1/apps/{base_token}/tables/tblO06JFd4XfZHCD/records
  ?page_size=50
...
| 表名 | Table ID | 说明 |
|------|----------|------|
| 宝宝档案 | `tbl3JyDUCGTsyNnj` | 存储宝宝基本信息 |
| 每日记录 | `tblO06JFd4XfZHCD` | 存储每日喂养/成长记录 |
| 成长里程碑 | `tbldWe9a9l80Qoho` | 存储成长关键节点 |

Base Token: `STWzbhiela2AcBsU2Cdcojjpnuf`
